---
name: xv-0542-funeral-of-gpt-4o
...
- Skill ID：`xv-0542-funeral-of-gpt-4o`
- 作者：数字生命卡兹克 (@Khazix0918)
- 原始语言：中文
- YouMind：https://youmind.com/zh-CN/landing/x-viral-articles/funeral-of-gpt-4o
- 原文：https://x.com/Khazix0918/status/2022152899850129528
- 本地文章：`2026-06-15-youmind-x-viral-articles-all/articles/0542-funeral-of-gpt-4o.md`
- 本地封面：`2026-06-15-youmind-x-viral-articles-all/covers/0542-funeral-of-gpt-4o.jpg`
- 数据：曝光 640045，点赞 1574，收藏 426
...
- 文本规模：约 4636 字符，162 个段落，0 个标题，0 个列表项，0 个引用块
- 爆款承诺：OpenAI 即将停用 GPT-4o。了解为什么成千上万的用户在怀念这款 AI 模型——它不仅是一个工具，更像是一位贴心的伙伴。

### 可复用文章提示词

```text
请使用「明天GPT-4o将正式谢幕风格双技能」的文章 skill 写一篇中文公众号文章。
...
避免：
- 不要写成泛泛鸡汤或百科说明。
- 不要把标题里的承诺摊薄，正文必须持续兑现「OpenAI 即将停用 GPT-4o。了解为什么成千上万的用户在怀念这款 AI 模型——它不仅是一个工具，更像是一位贴心的伙伴。」。
...
- 画面类型：克制的现代公众号题图
- 原图尺寸：1172x469，比例 2.50:1
- 主色板：#141414 charcoal 72% / #151414 charcoal 14% / #35332f charcoal 10% / #0d0d0d black 2% / #131413 charcoal 2%
- 明暗/饱和/对比：brightness 27，saturation 8，contrast 22
...
```text
Create a horizontal WeChat public-account article cover, 2.35:1 aspect ratio, for an article titled "明天，GPT-4o 将正式谢幕".

Central concept: 把抽象工具能力可视化为界面窗口、代码片段、节点网络、操作台、AI 工作流或发光的系统核心。

Style: preserve the reference cover's visual direction: 克制的现代公众号题图. Use a palette inspired by #141414 (charcoal), #151414 (charcoal), #35332f (charcoal), #0d0d0d (black). Keep the image editorial, conceptual, and readable as a small WeChat thumbnail.
...
Mood: match the article skill "明天GPT-4o将正式谢幕风格双技能" -- useful, sharp, high-signal, and slightly more memorable than a normal tutorial thumbnail.
