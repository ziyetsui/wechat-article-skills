---
name: xv-0377-openai-unit-distance-math-breakthrough
...
- Skill ID：`xv-0377-openai-unit-distance-math-breakthrough`
- 作者：Sebastien Bubeck (@SebastienBubeck)
- 原始语言：英文
- YouMind：https://youmind.com/zh-CN/landing/x-viral-articles/openai-unit-distance-math-breakthrough
- 原文：https://x.com/SebastienBubeck/status/2057187978720719114
- 本地文章：`2026-06-15-youmind-x-viral-articles-all/articles/0377-openai-unit-distance-math-breakthrough.md`
- 本地封面：`2026-06-15-youmind-x-viral-articles-all/covers/0377-openai-unit-distance-math-breakthrough.jpg`
- 数据：曝光 523619，点赞 1718，收藏 995
...
- 文本规模：约 3113 字符，11 个段落，0 个标题，0 个列表项，0 个引用块
- 爆款承诺：了解 OpenAI 的内部模型如何破解了一道困扰全球顶尖数学家 80 年之久的数学难题。

### 可复用文章提示词

```text
请使用「单位距离风格双技能」的文章 skill 写一篇中文公众号文章。
...
避免：
- 不要写成泛泛鸡汤或百科说明。
- 不要把标题里的承诺摊薄，正文必须持续兑现「了解 OpenAI 的内部模型如何破解了一道困扰全球顶尖数学家 80 年之久的数学难题。」。
...
- 画面类型：浅底极简信息图/产品幻灯片
- 原图尺寸：1644x658，比例 2.50:1
- 主色板：#cfcfcf cream 25% / #dedede cream 22% / #d4d4d4 cream 15% / #eaeaea white 14% / #f8f8f8 white 12%
- 明暗/饱和/对比：brightness 214，saturation 0，contrast 31
...
```text
Create a horizontal WeChat public-account article cover, 2.35:1 aspect ratio, for an article titled "单位距离".

Central concept: 把抽象工具能力可视化为界面窗口、代码片段、节点网络、操作台、AI 工作流或发光的系统核心。

Style: preserve the reference cover's visual direction: 浅底极简信息图/产品幻灯片. Use a palette inspired by #cfcfcf (cream), #dedede (cream), #d4d4d4 (cream), #eaeaea (white). Keep the image editorial, conceptual, and readable as a small WeChat thumbnail.
...
Mood: match the article skill "单位距离风格双技能" -- useful, sharp, high-signal, and slightly more memorable than a normal tutorial thumbnail.
