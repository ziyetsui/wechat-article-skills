---
name: xv-0804-altcoin-buying-strategy-guide
...
- Skill ID：`xv-0804-altcoin-buying-strategy-guide`
- 作者：YF (@TopYFT)
- 原始语言：英文
- YouMind：https://youmind.com/zh-CN/landing/x-viral-articles/altcoin-buying-strategy-guide
- 原文：https://x.com/TopYFT/status/2063307576901542084
- 本地文章：`2026-06-15-youmind-x-viral-articles-all/articles/0804-altcoin-buying-strategy-guide.md`
- 本地封面：`2026-06-15-youmind-x-viral-articles-all/covers/0804-altcoin-buying-strategy-guide.jpg`
- 数据：曝光 438888，点赞 108，收藏 6
...
- 文本规模：约 1035 字符，24 个段落，0 个标题，0 个列表项，4 个引用块
- 爆款承诺：停止盲目追求 100 倍回报，学习在加密货币市场中生存并获利的必要操作顺序。

### 可复用文章提示词

```text
请使用「在购买山寨币之前请阅读此文风格双技能」的文章 skill 写一篇中文公众号文章。
...
避免：
- 不要写成泛泛鸡汤或百科说明。
- 不要把标题里的承诺摊薄，正文必须持续兑现「停止盲目追求 100 倍回报，学习在加密货币市场中生存并获利的必要操作顺序。」。
...
- 主色板：#03070e black 32% / #1a0d20 charcoal 18% / #11273a charcoal 15% / #5f594b brown 13% / #502e34 charcoal 11%
- 明暗/饱和/对比：brightness 52，saturation 154，contrast 59
...
```text
Create a horizontal WeChat public-account article cover, 2.35:1 aspect ratio, for an article titled "在购买山寨币之前，请阅读此文".

Central concept: 把抽象工具能力可视化为界面窗口、代码片段、节点网络、操作台、AI 工作流或发光的系统核心。

Style: preserve the reference cover's visual direction: 暗色高反差电影感/寓言式封面. Use a palette inspired by #03070e (black), #1a0d20 (charcoal), #11273a (charcoal), #5f594b (brown). Keep the image editorial, conceptual, and readable as a small WeChat thumbnail.
...
Mood: match the article skill "在购买山寨币之前请阅读此文风格双技能" -- useful, sharp, high-signal, and slightly more memorable than a normal tutorial thumbnail.
