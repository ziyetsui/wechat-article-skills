---
name: xv-0499-how-dating-apps-change-you
...
- Skill ID：`xv-0499-how-dating-apps-change-you`
- 作者：やうゆ@yauyuism (@yauyuism)
- 原始语言：日文
- YouMind：https://youmind.com/zh-CN/landing/x-viral-articles/how-dating-apps-change-you
- 原文：https://x.com/yauyuism/status/2053717752238801090
- 本地文章：`2026-06-15-youmind-x-viral-articles-all/articles/0499-how-dating-apps-change-you.md`
- 本地封面：`2026-06-15-youmind-x-viral-articles-all/covers/0499-how-dating-apps-change-you.jpg`
- 数据：曝光 228566，点赞 779，收藏 565
...
- 文本规模：约 1494 字符，23 个段落，0 个标题，0 个列表项，0 个引用块
- 爆款承诺：探索长期使用约会软件如何重塑你的大脑，让你将他人视为数据点，并削弱你建立真实情感纽带的能力。

### 可复用文章提示词

```text
请使用「约会软件如何改变你的人性风格双技能」的文章 skill 写一篇中文公众号文章。
...
避免：
- 不要写成泛泛鸡汤或百科说明。
- 不要把标题里的承诺摊薄，正文必须持续兑现「探索长期使用约会软件如何重塑你的大脑，让你将他人视为数据点，并削弱你建立真实情感纽带的能力。」。
...
- 原图尺寸：750x300，比例 2.50:1
- 主色板：#191c18 charcoal 22% / #817d64 gray 20% / #58533d brown 17% / #3f3b2c charcoal 16% / #31f9c3 teal 15%
- 明暗/饱和/对比：brightness 100，saturation 93，contrast 59
...
```text
Create a horizontal WeChat public-account article cover, 2.35:1 aspect ratio, for an article titled "约会软件如何改变你的人性".

Central concept: 把抽象工具能力可视化为界面窗口、代码片段、节点网络、操作台、AI 工作流或发光的系统核心。

Style: preserve the reference cover's visual direction: 细节密集的拼贴/界面/图表视觉. Use a palette inspired by #191c18 (charcoal), #817d64 (gray), #58533d (brown), #3f3b2c (charcoal). Keep the image editorial, conceptual, and readable as a small WeChat thumbnail.
...
Mood: match the article skill "约会软件如何改变你的人性风格双技能" -- useful, sharp, high-signal, and slightly more memorable than a normal tutorial thumbnail.
