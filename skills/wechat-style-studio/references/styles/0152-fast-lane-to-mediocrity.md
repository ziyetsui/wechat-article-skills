---
name: xv-0152-fast-lane-to-mediocrity
...
- Skill ID：`xv-0152-fast-lane-to-mediocrity`
- 作者：Aditya Agarwal@adityaag (@adityaag)
- 原始语言：英文
- YouMind：https://youmind.com/zh-CN/landing/x-viral-articles/fast-lane-to-mediocrity
- 原文：https://x.com/adityaag/status/2054976557702066520
- 本地文章：`2026-06-15-youmind-x-viral-articles-all/articles/0152-fast-lane-to-mediocrity.md`
- 本地封面：`2026-06-15-youmind-x-viral-articles-all/covers/0152-fast-lane-to-mediocrity.jpg`
- 数据：曝光 410330，点赞 1689，收藏 2732
...
- 文本规模：约 1558 字符，18 个段落，0 个标题，0 个列表项，0 个引用块
- 爆款承诺：探索硅谷对速度的痴迷为何正在扼杀真正的创新，以及如何找到 AI 无法取代的核心优势。

### 可复用文章提示词

```text
请使用「通往平庸的快车道风格双技能」的文章 skill 写一篇中文公众号文章。
...
避免：
- 不要写成泛泛鸡汤或百科说明。
- 不要把标题里的承诺摊薄，正文必须持续兑现「探索硅谷对速度的痴迷为何正在扼杀真正的创新，以及如何找到 AI 无法取代的核心优势。」。
...
- 主色板：#000001 black 26% / #215443 charcoal 22% / #0e3633 charcoal 17% / #387152 green 16% / #5c9271 gray 10%
- 明暗/饱和/对比：brightness 53，saturation 120，contrast 43
...
```text
Create a horizontal WeChat public-account article cover, 2.35:1 aspect ratio, for an article titled "通往平庸的快车道".

Central concept: 把抽象工具能力可视化为界面窗口、代码片段、节点网络、操作台、AI 工作流或发光的系统核心。

Style: preserve the reference cover's visual direction: 高饱和海报/科技广告视觉. Use a palette inspired by #000001 (black), #215443 (charcoal), #0e3633 (charcoal), #387152 (green). Keep the image editorial, conceptual, and readable as a small WeChat thumbnail.
...
Mood: match the article skill "通往平庸的快车道风格双技能" -- useful, sharp, high-signal, and slightly more memorable than a normal tutorial thumbnail.
