---
name: xv-0544-99-percent-totality-product-quality
...
- Skill ID：`xv-0544-99-percent-totality-product-quality`
- 作者：Garry Tan (@garrytan)
- 原始语言：英文
- YouMind：https://youmind.com/zh-CN/landing/x-viral-articles/99-percent-totality-product-quality
- 原文：https://x.com/garrytan/status/2062760454649487491
- 本地文章：`2026-06-15-youmind-x-viral-articles-all/articles/0544-99-percent-totality-product-quality.md`
- 本地封面：`2026-06-15-youmind-x-viral-articles-all/covers/0544-99-percent-totality-product-quality.jpg`
- 数据：曝光 153994，点赞 366，收藏 423
...
- 文本规模：约 2006 字符，20 个段落，0 个标题，0 个列表项，0 个引用块
- 爆款承诺：探索为何 99% 不仅仅是一个四舍五入的误差——它决定了你的产品是平庸无奇，还是能为用户带来改变人生的体验。

### 可复用文章提示词

```text
请使用「991%的全食时刻风格双技能」的文章 skill 写一篇中文公众号文章。
...
避免：
- 不要写成泛泛鸡汤或百科说明。
- 不要把标题里的承诺摊薄，正文必须持续兑现「探索为何 99% 不仅仅是一个四舍五入的误差——它决定了你的产品是平庸无奇，还是能为用户带来改变人生的体验。」。
...
- 主色板：#0a1017 black 23% / #64574e brown 20% / #161d25 charcoal 15% / #292b2d charcoal 14% / #9f8773 gray 14%
- 明暗/饱和/对比：brightness 75，saturation 96，contrast 58
...
```text
Create a horizontal WeChat public-account article cover, 2.35:1 aspect ratio, for an article titled "99.1% 的全食时刻".

Central concept: 把抽象工具能力可视化为界面窗口、代码片段、节点网络、操作台、AI 工作流或发光的系统核心。

Style: preserve the reference cover's visual direction: 暗色高反差电影感/寓言式封面. Use a palette inspired by #0a1017 (black), #64574e (brown), #161d25 (charcoal), #292b2d (charcoal). Keep the image editorial, conceptual, and readable as a small WeChat thumbnail.
...
Mood: match the article skill "991%的全食时刻风格双技能" -- useful, sharp, high-signal, and slightly more memorable than a normal tutorial thumbnail.
