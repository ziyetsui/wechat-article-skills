---
name: xv-0038-ai-external-brain-claude-obsidian
...
# 从零开始构建AI外脑ClaudeCode与O…风格双技能

源文章：从零开始构建“AI 外脑”：Claude Code 与 Obsidian 实战指南

- Skill ID：`xv-0038-ai-external-brain-claude-obsidian`
- 作者：Claude Code Studio (@ClaudeCode_love)
- 原始语言：日文
- YouMind：https://youmind.com/zh-CN/landing/x-viral-articles/ai-external-brain-claude-obsidian
- 原文：https://x.com/ClaudeCode_love/status/2042886840177557533
- 本地文章：`2026-06-15-youmind-x-viral-articles-all/articles/0038-ai-external-brain-claude-obsidian.md`
- 本地封面：`2026-06-15-youmind-x-viral-articles-all/covers/0038-ai-external-brain-claude-obsidian.jpg`
- 数据：曝光 1598613，点赞 2625，收藏 7668
...
- 文本规模：约 4903 字符，131 个段落，0 个标题，5 个列表项，0 个引用块
- 爆款承诺：别再把 Token 浪费在遗忘的上下文上！参考 Karpathy 的理念，利用 Claude 和 Obsidian 构建一套永久的 AI 记忆系统。

### 可复用文章提示词

```text
请使用「从零开始构建AI外脑ClaudeCode与O…风格双技能」的文章 skill 写一篇中文公众号文章。
...
避免：
- 不要写成泛泛鸡汤或百科说明。
- 不要把标题里的承诺摊薄，正文必须持续兑现「别再把 Token 浪费在遗忘的上下文上！参考 Karpathy 的理念，利用 Claude 和 Obsidian 构建一套永久的 AI 记忆系统。」。
...
- 主色板：#c6e8fa white 25% / #dad6f6 white 23% / #d1e0f8 white 17% / #978ea9 gray 13% / #d3d9f6 white 12%
- 明暗/饱和/对比：brightness 206，saturation 47，contrast 45
...
```text
Create a horizontal WeChat public-account article cover, 2.35:1 aspect ratio, for an article titled "从零开始构建“AI 外脑”：Claude Code 与 Obsidian 实战指南".

Central concept: 把抽象工具能力可视化为界面窗口、代码片段、节点网络、操作台、AI 工作流或发光的系统核心。

Style: preserve the reference cover's visual direction: 浅底极简信息图/产品幻灯片. Use a palette inspired by #c6e8fa (white), #dad6f6 (white), #d1e0f8 (white), #978ea9 (gray). Keep the image editorial, conceptual, and readable as a small WeChat thumbnail.
...
Mood: match the article skill "从零开始构建AI外脑ClaudeCode与O…风格双技能" -- useful, sharp, high-signal, and slightly more memorable than a normal tutorial thumbnail.
