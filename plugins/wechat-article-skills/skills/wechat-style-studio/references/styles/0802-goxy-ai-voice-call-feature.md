---
name: xv-0802-goxy-ai-voice-call-feature
...
- Skill ID：`xv-0802-goxy-ai-voice-call-feature`
- 作者：GOXY@Goxy_ai (@Goxy_ai)
- 原始语言：英文
- YouMind：https://youmind.com/zh-CN/landing/x-viral-articles/goxy-ai-voice-call-feature
- 原文：https://x.com/Goxy_ai/status/2056101294809690563
- 本地文章：`2026-06-15-youmind-x-viral-articles-all/articles/0802-goxy-ai-voice-call-feature.md`
- 本地封面：`2026-06-15-youmind-x-viral-articles-all/covers/0802-goxy-ai-voice-call-feature.jpg`
- 数据：曝光 211880，点赞 15，收藏 7
...
- 小标题样本：设置 / 为什么要用钱包 / 我为什么还是做了 / 期待什么
- 文本规模：约 809 字符，15 个段落，4 个标题，0 个列表项，1 个引用块
- 爆款承诺：体验 Goxy 全新语音通话功能带来的 AI 交互未来——立即连接你的钱包，开启对话。

### 可复用文章提示词

```text
请使用「来和我聊聊吧字面意义上的那种风格双技能」的文章 skill 写一篇中文公众号文章。
...
6. 小标题参考：设置 / 为什么要用钱包 / 我为什么还是做了 / 期待什么
...
避免：
- 不要写成泛泛鸡汤或百科说明。
- 不要把标题里的承诺摊薄，正文必须持续兑现「体验 Goxy 全新语音通话功能带来的 AI 交互未来——立即连接你的钱包，开启对话。」。
...
- 画面类型：暗色高反差电影感/寓言式封面
- 原图尺寸：1680x672，比例 2.50:1
- 主色板：#020202 black 28% / #100b05 black 26% / #7b5d27 brown 18% / #030302 black 18% / #010101 black 10%
- 明暗/饱和/对比：brightness 30，saturation 97，contrast 50
...
```text
Create a horizontal WeChat public-account article cover, 2.35:1 aspect ratio, for an article titled "来和我聊聊吧，字面意义上的那种。".

Central concept: 把抽象工具能力可视化为界面窗口、代码片段、节点网络、操作台、AI 工作流或发光的系统核心。

Style: preserve the reference cover's visual direction: 暗色高反差电影感/寓言式封面. Use a palette inspired by #020202 (black), #100b05 (black), #7b5d27 (brown), #030302 (black). Keep the image editorial, conceptual, and readable as a small WeChat thumbnail.
...
Mood: match the article skill "来和我聊聊吧字面意义上的那种风格双技能" -- useful, sharp, high-signal, and slightly more memorable than a normal tutorial thumbnail.
