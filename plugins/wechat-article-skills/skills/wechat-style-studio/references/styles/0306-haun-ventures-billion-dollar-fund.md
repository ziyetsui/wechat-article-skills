---
name: xv-0306-haun-ventures-billion-dollar-fund
...
# 投入10亿美元支持构建新经济的创业者风格双技能

源文章：投入 10 亿美元，支持构建新经济的创业者

- Skill ID：`xv-0306-haun-ventures-billion-dollar-fund`
- 作者：Katie Haun (@katie_haun)
- 原始语言：英文
- YouMind：https://youmind.com/zh-CN/landing/x-viral-articles/haun-ventures-billion-dollar-fund
- 原文：https://x.com/katie_haun/status/2051318562497716655
- 本地文章：`2026-06-15-youmind-x-viral-articles-all/articles/0306-haun-ventures-billion-dollar-fund.md`
- 本地封面：`2026-06-15-youmind-x-viral-articles-all/covers/0306-haun-ventures-billion-dollar-fund.jpg`
- 数据：曝光 720101，点赞 1735，收藏 1359
...
- 文本规模：约 883 字符，9 个段落，0 个标题，3 个列表项，0 个引用块
- 爆款承诺：Haun Ventures 宣布设立 10 亿美元的巨额基金，旨在推动下一代全球金融基础设施及 AI 驱动的 Agent 经济发展。

### 可复用文章提示词

```text
请使用「投入10亿美元支持构建新经济的创业者风格双技能」的文章 skill 写一篇中文公众号文章。
...
避免：
- 不要写成泛泛鸡汤或百科说明。
- 不要把标题里的承诺摊薄，正文必须持续兑现「Haun Ventures 宣布设立 10 亿美元的巨额基金，旨在推动下一代全球金融基础设施及 AI 驱动的 Agent 经济发展。」。
...
- 主色板：#f8f6e9 white 92% / #f7f6e8 white 3% / #c7c6bb cream 3% / #fcfbf0 white 2% / #f9f6ea white 1%
- 明暗/饱和/对比：brightness 243，saturation 15，contrast 18
...
```text
Create a horizontal WeChat public-account article cover, 2.35:1 aspect ratio, for an article titled "投入 10 亿美元，支持构建新经济的创业者".

Central concept: 把抽象工具能力可视化为界面窗口、代码片段、节点网络、操作台、AI 工作流或发光的系统核心。

Style: preserve the reference cover's visual direction: 浅底极简信息图/产品幻灯片. Use a palette inspired by #f8f6e9 (white), #f7f6e8 (white), #c7c6bb (cream), #fcfbf0 (white). Keep the image editorial, conceptual, and readable as a small WeChat thumbnail.
...
Mood: match the article skill "投入10亿美元支持构建新经济的创业者风格双技能" -- useful, sharp, high-signal, and slightly more memorable than a normal tutorial thumbnail.
