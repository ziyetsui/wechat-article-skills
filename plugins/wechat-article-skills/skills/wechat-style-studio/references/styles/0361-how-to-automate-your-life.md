---
name: xv-0361-how-to-automate-your-life
...
- Skill ID：`xv-0361-how-to-automate-your-life`
- 作者：AI Edge@aiedge_ (@aiedge_)
- 原始语言：英文
- YouMind：https://youmind.com/zh-CN/landing/x-viral-articles/how-to-automate-your-life
- 原文：https://x.com/aiedge_/status/2057816817708789940
- 本地文章：`2026-06-15-youmind-x-viral-articles-all/articles/0361-how-to-automate-your-life.md`
- 本地封面：`2026-06-15-youmind-x-viral-articles-all/covers/0361-how-to-automate-your-life.jpg`
- 数据：曝光 223819，点赞 366，收藏 1081
...
- 小标题样本：第一步：我该自动化什么？ / 第二步：设计方案 / 第三步：执行层 / 福利：免费资源 / 结语
- 文本规模：约 2862 字符，61 个段落，5 个标题，4 个列表项，0 个引用块
- 爆款承诺：掌握三步工作法，利用最新的 AI Agent 技术自动化处理日常任务，每周节省数小时时间。

### 可复用文章提示词

```text
请使用「如何实现生活自动化分步指南风格双技能」的文章 skill 写一篇中文公众号文章。
...
6. 小标题参考：第一步：我该自动化什么？ / 第二步：设计方案 / 第三步：执行层 / 福利：免费资源 / 结语
...
避免：
- 不要写成泛泛鸡汤或百科说明。
- 不要把标题里的承诺摊薄，正文必须持续兑现「掌握三步工作法，利用最新的 AI Agent 技术自动化处理日常任务，每周节省数小时时间。」。
...
- 原图尺寸：1410x564，比例 2.50:1
- 主色板：#050505 black 24% / #b8b8b8 cream 19% / #fbfbfb white 17% / #2d2d2d charcoal 14% / #edeef0 white 13%
- 明暗/饱和/对比：brightness 127，saturation 1，contrast 96
...
```text
Create a horizontal WeChat public-account article cover, 2.35:1 aspect ratio, for an article titled "如何实现生活自动化（分步指南）".

Central concept: 把抽象工具能力可视化为界面窗口、代码片段、节点网络、操作台、AI 工作流或发光的系统核心。

Style: preserve the reference cover's visual direction: 黑白或低饱和 editorial 插画/照片. Use a palette inspired by #050505 (black), #b8b8b8 (cream), #fbfbfb (white), #2d2d2d (charcoal). Keep the image editorial, conceptual, and readable as a small WeChat thumbnail.
...
Mood: match the article skill "如何实现生活自动化分步指南风格双技能" -- useful, sharp, high-signal, and slightly more memorable than a normal tutorial thumbnail.
