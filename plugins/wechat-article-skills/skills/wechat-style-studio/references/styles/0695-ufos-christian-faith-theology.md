---
name: xv-0695-ufos-christian-faith-theology
...
- Skill ID：`xv-0695-ufos-christian-faith-theology`
- 作者：Monty L. Donohew🇺🇸✝️🕎@montydonohew (@montydonohew)
- 原始语言：英文
- YouMind：https://youmind.com/zh-CN/landing/x-viral-articles/ufos-christian-faith-theology
- 原文：https://x.com/montydonohew/status/2055358569630036022
- 本地文章：`2026-06-15-youmind-x-viral-articles-all/articles/0695-ufos-christian-faith-theology.md`
- 本地封面：`2026-06-15-youmind-x-viral-articles-all/covers/0695-ufos-christian-faith-theology.jpg`
- 数据：曝光 973494，点赞 409，收藏 92
...
- 文本规模：约 1943 字符，18 个段落，0 个标题，3 个列表项，0 个引用块
- 爆款承诺：探索为什么外星生命的存在并不与《圣经》相矛盾，以及坚定的信仰如何拥抱更广阔的宇宙。

### 可复用文章提示词

```text
请使用「UFO不应动摇你的信仰风格双技能」的文章 skill 写一篇中文公众号文章。
...
避免：
- 不要写成泛泛鸡汤或百科说明。
- 不要把标题里的承诺摊薄，正文必须持续兑现「探索为什么外星生命的存在并不与《圣经》相矛盾，以及坚定的信仰如何拥抱更广阔的宇宙。」。
...
- 画面类型：暗色高反差电影感/寓言式封面
- 原图尺寸：624x250，比例 2.50:1
- 主色板：#0e1221 charcoal 21% / #4e414a brown 20% / #161d2e charcoal 17% / #27232e charcoal 15% / #8e756c gray 15%
- 明暗/饱和/对比：brightness 73，saturation 95，contrast 64
...
```text
Create a horizontal WeChat public-account article cover, 2.35:1 aspect ratio, for an article titled "UFO 不应动摇你的信仰".

Central concept: 把抽象工具能力可视化为界面窗口、代码片段、节点网络、操作台、AI 工作流或发光的系统核心。

Style: preserve the reference cover's visual direction: 暗色高反差电影感/寓言式封面. Use a palette inspired by #0e1221 (charcoal), #4e414a (brown), #161d2e (charcoal), #27232e (charcoal). Keep the image editorial, conceptual, and readable as a small WeChat thumbnail.
...
Mood: match the article skill "UFO不应动摇你的信仰风格双技能" -- useful, sharp, high-signal, and slightly more memorable than a normal tutorial thumbnail.
