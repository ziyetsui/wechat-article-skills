---
name: xv-0736-final-wish-cream-bun-story
...
- Skill ID：`xv-0736-final-wish-cream-bun-story`
- 作者：ももなっち🍑@petinfome (@petinfome)
- 原始语言：日文
- YouMind：https://youmind.com/zh-CN/landing/x-viral-articles/final-wish-cream-bun-story
- 原文：https://x.com/petinfome/status/2053757988935188874
- 本地文章：`2026-06-15-youmind-x-viral-articles-all/articles/0736-final-wish-cream-bun-story.md`
- 本地封面：`2026-06-15-youmind-x-viral-articles-all/covers/0736-final-wish-cream-bun-story.jpg`
- 数据：曝光 10511233，点赞 123，收藏 50
...
- 文本规模：约 504 字符，20 个段落，0 个标题，0 个列表项，0 个引用块
- 爆款承诺：探索这个既搞笑又感人的故事，讲述了一位老人的临终愿望，虽然过程有些出人意料。

### 可复用文章提示词

```text
请使用「我最后想吃一个奶油面包风格双技能」的文章 skill 写一篇中文公众号文章。
...
避免：
- 不要写成泛泛鸡汤或百科说明。
- 不要把标题里的承诺摊薄，正文必须持续兑现「探索这个既搞笑又感人的故事，讲述了一位老人的临终愿望，虽然过程有些出人意料。」。
...
- 主色板：#c6a983 pink 25% / #a68864 gray 21% / #d8be9a cream 14% / #f0ecdc cream 14% / #ecd7b3 cream 13%
- 明暗/饱和/对比：brightness 185，saturation 75，contrast 33
- 构图策略：中等密度，适合一个主视觉隐喻配少量标题文字。
- 视觉隐喻：围绕“我最后想吃一个奶油面包”提炼一个单一视觉隐喻，避免把全文信息塞进画面。

### 可复用封面提示词

```text
Create a horizontal WeChat public-account article cover, 2.35:1 aspect ratio, for an article titled "我最后想吃一个奶油面包".

Central concept: 围绕“我最后想吃一个奶油面包”提炼一个单一视觉隐喻，避免把全文信息塞进画面。

Style: preserve the reference cover's visual direction: 克制的现代公众号题图. Use a palette inspired by #c6a983 (pink), #a68864 (gray), #d8be9a (cream), #f0ecdc (cream). Keep the image editorial, conceptual, and readable as a small WeChat thumbnail.
...
Mood: match the article skill "我最后想吃一个奶油面包风格双技能" -- useful, sharp, high-signal, and slightly more memorable than a normal tutorial thumbnail.
